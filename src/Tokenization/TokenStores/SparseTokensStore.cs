...
public class SparseTokensStore
{
    ...
    public FluidX.TextBuffers.TextRange SetPartial(FluidX.TextBuffers.TextRange _range, List<SparseMultilineTokens> pieces)
    {
    ...
    public void AcceptEdit(
        FluidX.TextBuffers.TextRange range,
        int eolCount,
        int firstLineLength,
        int lastLineLength,
        char firstCharCode)
