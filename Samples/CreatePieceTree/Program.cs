...
Console.WriteLine(buffer.GetValueInRange(new EditorTextBuffers.Range(1, 2, 2, 2), EndOfLinePreference.LF)); // ello\nw
...
{
    Range = new EditorTextBuffers.Range(2, 4, 2, 4), // Empty range = insert at this position
...
{
    Range = new EditorTextBuffers.Range(1, 4, 1, 5), // Covers single character
